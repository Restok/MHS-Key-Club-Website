...
<nav class="navbar navbar-expand-lg navbar-light fixed-top" id = "not-in-view" style = "opacity: 1;">
  <a class="navbar-brand" href="#"><span class= "logo"><img src="img/MHSKeyClub-white.png" width= "150"></span></a>
...
<div class = "bgimage" style = "border-bottom:none;background: url(img/kcpics/UWCN1713.jpg) no-repeat center center / cover;">

<div class = "bgimage" style = "border-bottom:none; opacity: 0.7;">
	</div>
...
<div class = "header" style = "opacity:0.9">
	...
	<img src="img/KEY-CLUB-SEAL-Color-1.png"  id = "control" class = "menu mcenter" onClick="popUp()" alt="Key Club Logo">
  
	<a href = "about.html"><div id = "op1" class = "menu moption1"><span class = "navtxt">About</span></div></a>
	
	<div id = "op2" class = "menu moption2" data-toggle="modal" data-target=".ABmodal_slideRight"><span class = "navtxt">Join</span></div>
...
<!--<div class = "g-element"></div>-->
	...
	<!--background:linear-gradient(white, #dbf4fc)-->
...
<div class = "container about2" style = "background-color:#6a859c;left: 50%;transform: translateX(-50%);">
		<div class = "row">
			<div class = "col-md-6">
			<div class="card">
			  <img class="card-img-top" src="https://s3.amazonaws.com/keyclub-wpassets/wp-content/uploads/2017/08/24130615/KeyClub_DIST_Map_1-resize.jpg" alt="Card image">
			  <div class="card-body">
		...
		<div class = "col-md-6">
			<div class="card">
			  <img class="card-img-top" src="https://s3.amazonaws.com/keyclub-wpassets/wp-content/uploads/2017/08/24130615/KeyClub_INT_Map_2-resize.jpg" alt="Card image">
			  <div class="card-body">
				<h4 class="card-title">John Doe</h4>
				<p class="card-text">Some example text.</p>
			  </div>
